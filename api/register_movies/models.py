...
class RegisterMovie(models.Model):
    ...
    viewMovie: str = models.CharField(max_length=100, verbose_name='Вид фильма', null=True, blank=True)
    ...
    countryOfProduction: str = models.CharField(max_length=100, verbose_name='Страна производства', null=True, blank=True)
